...
class FormatterTest(unittest.TestCase):
  ...
  def test_3_2_2(self):
    self.wiki.make_html('}0CamelWord||e*!query:wiki:fg5-afg7/{i-wiki:5`\'b[/b0+.fh5a<CamelWord.=4d\'\n  8 .*[h3cf7.|_>')

  def test_3_2_2_1(self):
    self.wiki.make_html('}0CamelWord||e*!query:wiki:fg5-afg7/{i-wiki:5`\'b[/b0+.fh5a<CamelWord.=4d\'')

  def test_3_2_2_2(self):
    self.wiki.make_html('  8 .*[h3cf7.|_>')

  def test_bad_indent(self):
    self.wiki.make_html('  8 ')
